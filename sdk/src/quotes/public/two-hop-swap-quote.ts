...
export function twoHopSwapQuoteFromSwapQuotes(
  ...
  return {
    ...
    tickArray0: swapQuoteOne.tickArray0,
    tickArray1: swapQuoteOne.tickArray1,
    tickArray2: swapQuoteOne.tickArray2,
    tickArray3: swapQuoteTwo.tickArray0,
    tickArray4: swapQuoteTwo.tickArray1,
    tickArray5: swapQuoteTwo.tickArray2,
